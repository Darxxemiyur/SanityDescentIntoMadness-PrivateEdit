...
public class ModelRottingStalker extends AnimatedGeoModel<RottingStalker>
{
    ...
    @Override
    public ResourceLocation getModelLocation(RottingStalker object)
    {
        return MODEL_LOCATION;
    }

    @Override
    public ResourceLocation getTextureLocation(RottingStalker object)
    {
        return TEXTURE_LOCATION;
    }

    @Override
    public ResourceLocation getAnimationFileLocation(RottingStalker animatable)
    {
