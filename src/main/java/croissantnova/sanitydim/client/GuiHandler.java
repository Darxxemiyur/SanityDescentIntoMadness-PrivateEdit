...
public class GuiHandler
{
    ...
    private void renderBloodTendrilsOverlay(ForgeIngameGui gui, PoseStack poseStack, float partialTicks, int scw, int sch)
    {
...
//        ForgeGui.blit(poseStack, 0, 0, scw, sch, 0, 0, 64, 36, 64, 36);
    ...
    public void initOverlays()
    {
        ...
        OverlayRegistry.registerOverlayAbove(ForgeIngameGui.VIGNETTE_ELEMENT, SanityMod.MODID.concat(".blood_tendrils_overlay"), this::renderBloodTendrilsOverlay);
    }
